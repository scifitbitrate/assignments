...
## 1. Download data for all of the zip codes in Los Angeles county on education levels. Note that I used 2016 data in all cases.
...
## Extra: Compare LA County to the rest of California
```{r}
census_api_key ("your census key")
