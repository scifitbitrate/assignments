...
## 1. Choose a dependent variable and plot that dependent (Reading Scores) variable as a function
of a continuous independent variable (SES).
...
## 2. If you need to, adjust the scale of either the dependent variable or independent
variable to make more sense.
...
## 4. Clean up the labeling and description of the graphic so that it could be
presented to a broader audience.
...
5. In your .Rmd file, include a few sentences describing what the graphic
above shows.
